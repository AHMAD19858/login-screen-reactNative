      ...
      <View style={styles.indexView}>
        ...
        <View style={{ height: height / 3, justifyContent: 'center' }}>
          ...
          <TapGestureHandler onHandlerStateChange={this.onStateChange}>
            ...
            <Animated.View style={{ ...styles.buttons,  transform: [{ translateY: this.buttonY }] }}>
              <Text style={{ fontSize: 18, fontWeight:'bold'}}> Sign in</Text>
            </Animated.View>

          </TapGestureHandler>

          <Animated.View style={{ ...styles.buttons, backgroundColor: '#2e71dc', opacity: this.buttonOpacity, transform: [{ translateY: this.buttonY }] }}>
